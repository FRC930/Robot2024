...
public class MechanismSimulator {
    ...
    public MechanismSimulator(PivotSubsystem pivot,ElevatorSubsystem shootingElevator, ElevatorSubsystem climbingElevator, TurretSubsystem turret) {
        m_pivot = pivot;
    ...
    public void periodic() {
        ...
        SmartDashboard.putData(this.getClass().getSimpleName()+"/turret2d",m_turretAssembly);
    }
}
